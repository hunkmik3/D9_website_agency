const PROJECTS = {
  ...
  "sao-thai-duong-qc": {
    ...
    desc: "Dự án quảng cáo nổi bật của Sao Thái Dương."
  },
  "yeu-boi-loi-qc": {
    name: "YÊU BƠI LỘI (QC)",
    image: "/images/projects/yeu-boi-loi-qc.jpg",
    desc: "Dự án quảng cáo nổi bật của Yêu Bơi Lội."
  },
  "jewis-qc": {
    name: "JEWIS (QC)",
    image: "/images/projects/jewis-qc.jpg",
    desc: "Dự án quảng cáo nổi bật của Jewis."
  },
  "fimciti-qc": {
    name: "FIMCITI (QC)",
    image: "/images/projects/fimciti-qc.jpg",
    desc: "Dự án quảng cáo nổi bật của Fimciti."
  },
  "sao-my-restaurant-qc": {
    name: "SAO MỸ RESTAURANT (QC)",
    image: "/images/projects/sao-my-restaurant-qc.jpg",
    desc: "Dự án quảng cáo nổi bật của Sao Mỹ Restaurant."
  },
  "xo-seafood-qc": {
    name: "XÔ SEAFOOD (QC)",
    image: "/images/projects/xo-seafood-qc.jpg",
    desc: "Dự án quảng cáo nổi bật của Xô Seafood."
  },
  "30-phut-tieng-nhat-qc": {
    name: "30 PHÚT TIẾNG NHẬT (QC)",
    image: "/images/projects/30-phut-tieng-nhat-qc.jpg",
    desc: "Dự án quảng cáo nổi bật của 30 Phút Tiếng Nhật."
  },
  "quan-nho-qc": {
    name: "QUÁN NHỎ (QC)",
    image: "/images/projects/quan-nho-qc.jpg",
    desc: "Dự án quảng cáo nổi bật của Quán Nhỏ."
  },
  "lipo-healthy-food-tv": {
    name: "LIPO HEALTHY FOOD (TV)",
    image: "/images/projects/lipo-healthy-food-tv.jpg",
    desc: "Dự án tư vấn nổi bật của Lipo Healthy Food."
  },
  "glucankid-tv": {
    name: "GLUCANKID (TV)",
    image: "/images/projects/glucankid-tv.jpg",
    desc: "Dự án tư vấn nổi bật của Glucankid."
  },
  "nen-mong-dang-quang-tv": {
    name: "NỀN MÓNG ĐĂNG QUANG (TV)",
    image: "/images/projects/nen-mong-dang-quang-tv.jpg",
    desc: "Dự án tư vấn nổi bật của Nền Móng Đăng Quang."
  },
  "sao-thai-duong-tv": {
    name: "SAO THÁI DƯƠNG (TV)",
    image: "/images/projects/sao-thai-duong-tv.jpg",
    desc: "Dự án tư vấn nổi bật của Sao Thái Dương."
  }
};
...
export default function ProjectDetailPage({ params }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white py-16 px-4">
      <div className="max-w-3xl mx-auto bg-white/90 rounded-3xl shadow-xl p-8 md:p-14">
        <img src={project.image} alt={project.name} className="w-full h-64 object-cover object-center rounded-2xl mb-8" />
        <h1 className="text-3xl md:text-5xl font-extrabold text-center mb-6 text-blue-800 drop-shadow-sm tracking-tight">
          {project.name}
        </h1>
        <p className="text-lg md:text-xl text-gray-700 text-center mb-4">
          {project.desc}
        </p>
        {/* Bạn có thể bổ sung thêm các section chi tiết, hình ảnh, kết quả, testimonial... ở đây */}
      </div>
    </div>
  );
}
